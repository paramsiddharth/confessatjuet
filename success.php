...
<?php
echo "You confession has been successfully submitted! It will be uploaded to our <a href=\"$insta\" class=\"s\">Instagram page</a>. Be patient! It might take a while to get it done.";
?>
<br/><br/><a style="font-size: 22px" class="s" href="index.php">Make another confession</a>
</div>
