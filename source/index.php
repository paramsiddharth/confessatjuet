...
<?php
echo "You confession will be uploaded to our <a href=\"$insta\" class=\"s\">Instagram page</a>. Be patient! It might take a while to get it done.";
?>
</div>
<div id="main">
<form action="submit.php" method="post">
<span style="font-size: 20px;">Enter your confession: </span>
<br/>
<textarea name="confession" style="width: 60%; height: 100px; border-radius: 6px; font-size: 18px;" placeholder="I would like to confess..." required></textarea>
<br/><br/>
